...
public class ReadableModelTest {
        ...
        public void predictGzip() throws Exception {
                ...
                m.makeSureItWorks(m.model, Paths.get(tdir.toString(), "test.txt.gz").toFile(),
                                Paths.get(tdir.toString(), "predictions.txt.gz").toFile(), false);
        ...
        public void brokenInput() throws Exception {
                InputStream is = this.getClass().getClassLoader().getResourceAsStream("testgz/readable_model.txt.gz");
        ...
        public void testErrorPileup() throws Exception {
                File tdir = new File(this.getClass().getClassLoader().getResource("test_error_pileup").getFile());
                ReadableModel m = new ReadableModel(tdir);
        ...
        public void hashAllVsStrings() throws Exception {
                ...
                ReadableModel mHashAll = new ReadableModel(
